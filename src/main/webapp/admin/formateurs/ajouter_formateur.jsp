...
<head>
    <meta charset="utf-8">
    <title>FormaPRO - Ajouter un Formateur</title>
    ...
    <style>
        ...
        .btn-submit { background-color: #112958; color: white; padding: 12px 30px; border: none; border-radius: 8px; cursor: pointer; transition: all 0.3s; }
        ...
        .modal-content { background-color: #fefefe; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.3); width: 90%; max-width: 400px; animation-name: animatetop; animation-duration: 0.4s; position: relative; }
...
<div class="main-content">
    <jsp:include page="../header.jsp">
        <jsp:param name="pageTitle" value="Ajouter un Formateur" />
    </jsp:include>
            ...
            <div id="toastError" class="toast-notification alert-error">
                <div style="display:flex; align-items:center;">
                    ...
                    <span>
                        ...
                        <% } else if ("MissingFields".equals(error)) { %> Champs obligatoires manquants.
                        <% } else if ("MissingFormations".equals(error)) { %> Vous devez sélectionner au moins une formation.
        ...
        <div class="content-split">
            <div class="card form-container">
                <div class="card-header">
                    ...
                    <a href="/admin/formateurs/liste_formateurs" class="btn-back"><i class="fa fa-arrow-left"></i> Retour</a>
                </div>

                <div class="card-body">
                    <form id="addFormateurForm" method="post" action="${pageContext.request.contextPath}/admin/formateurs/ajouter">
                        <input type="hidden" name="role" value="FORMATEUR">

                        <div class="row" style="display:flex; gap:20px;">
                            <div class="form-group" style="flex:1;">
                                <label>Prénom</label>
                                <input type="text" name="firstName" class="form-control" required placeholder="Ex: Ahmed">
                            </div>
                            <div class="form-group" style="flex:1;">
                                <label>Nom</label>
                                <input type="text" name="lastName" class="form-control" required placeholder="Ex: Ben Salah">
                            </div>
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" required placeholder="Ex: ahmed@gmail.com">
                        </div>

                        <div class="form-group">
                            <label>Téléphone</label>
                            <input type="tel" name="phoneNumber" class="form-control" placeholder="Ex: 22334455" pattern="^\d{8}$" title="Le numéro doit contenir exactement 8 chiffres" required>
                        </div>
                        ...
                        <div class="row" style="display:flex; gap:20px;">
                            ...
                            <div class="form-group" style="flex:1;">
                                ...
                                <small id="passwordError" style="color:#ef4444; display:none; margin-top:5px; font-weight:600;">
                            ...
                            <div class="formation-list">
                                <% for (Formation f : formations) { %>
                                    <label class="checkbox-container">
                                        <input type="checkbox" name="formationIds" value="<%=f.getId()%>">
...
<div id="confirmModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Voulez-vous vraiment ajouter ce nouveau formateur ?</p>
        </div>
...
<script>
    function validateAndConfirm() {
        var form = document.getElementById("addFormateurForm");
        if (!form) return;
    ...
    function submitForm() {
        document.getElementById("addFormateurForm").submit();
    }
