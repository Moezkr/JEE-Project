...
<head>
    <meta charset="utf-8">
    <title>FormaPRO - Contactez le Centre de Formation</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Contact, Adresse, Téléphone, Centre de formation, Inscription" name="keywords">
    <meta content="Page de contact de notre centre de formation professionnelle" name="description">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Notre Adresse</h4>
                                <p class="m-0">123 Rue de la Formation, Tunis</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="contact-form">
                        <form onsubmit="event.preventDefault(); alert('Merci pour votre message !');">
                            <div class="row">
