...
<div class="sidebar" style="background: #10b981;">
    <div class="sidebar-brand">
        <h2>
            <i class="fa fa-graduation-cap" style="color: #ffc107; margin-right:5px;"></i>
            <span>ETUDIANT</span>
        </h2>
    </div>
    ...
    <ul class="sidebar-menu">
        <li>
            <a href="<%= request.getContextPath() %>/etudiant/dashboard.jsp"
               class="<%= request.getRequestURI().endsWith("/etudiant/dashboard.jsp") ? "active" : "" %>"
        ...
        <li>
            <a href="<%= request.getContextPath() %>/etudiant/emplois"
               class="<%= request.getRequestURI().contains("/etudiant/emplois") ? "active" : "" %>"
               style="border-left-color: #ffc107;">
