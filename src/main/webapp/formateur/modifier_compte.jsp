...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/formateur_dashboard.css">
            ...
            <div class="card form-container">
                ...
                <div class="card-body">
                    <form id="editCompteForm" method="post" action="<%= request.getContextPath() %>/compte/modifier">
                        ...
                        <h4 style="font-size: 1.1rem; color: #1e293b; margin: 30px 0 25px 0; font-weight: 700; padding-bottom: 10px; border-bottom: 1px solid #e2e8f0;">
